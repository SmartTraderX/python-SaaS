...
def generateSignal(dataforTrade, dataForTrend1h, dataForTrend4h):
    ...
    if trend_4h == "SIDEWAYS" or trend_1h == "SIDEWAYS":
        return None
=======
# def generateSignal(dataforTrade,dataForTrend4h):
...
#     if trend_4h == "SIDEWAYS":#or trend_1h == "SIDEWAYS":
#         return None
>>>>>>> 92d2ec4 (add seasonal wise obwesratation)
...
#     isVolume = volumecheck(dataforTrade)
#     swingHigh_value = swingHigh(dataforTrade)
#     swingLow_value = swingLow(dataforTrade)
#     #  Multi-timeframe confirmation
#     if  trend_4h == "STRONG_UPTREND" and strong:
#         return "BUY"

#     elif trend_4h == "STRONG_DOWNTREND" and strong :
#         return "SELL"
>>>>>>> 92d2ec4 (add seasonal wise obwesratation)
...
df = pd.DataFrame({
    "High": [100, 102, 105, 101, 98, 99, 103, 101]
})
...
df["swing_high_final"] = df["swing_high_raw"].shift(2)
